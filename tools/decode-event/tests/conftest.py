"""Shared pytest fixtures for cloudflow-decode-event tests.
...
unavailable) for the --stream input-mode tests.
"""
...
_PKG_ROOT = _HERE.parent  # tools/decode-event
_REPO_ROOT = _PKG_ROOT.parent.parent  # repo root
_SINK_SRC = _REPO_ROOT / "sinks" / "cloudflow-sink-splunk" / "src"

for _p in (_PKG_ROOT / "src", _SINK_SRC, _SINK_SRC / "cloudflow_pb"):
