...
Deliberately duplicated from tools/decode-event/ rather than factored into a
...
# This file lives at tools/stream-inspect/src/cloudflow_stream_inspect/redis_endpoint.py.
